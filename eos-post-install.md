...
## 1. Basics
### 1.1. Change locale
EOS doesn't let you set Irish locale, I would use GB for the install and change it later
```bash
sudo localectl set-locale LANG=en_IE.UTF-8
localectl set-x11-keymap ie pc105 "" terminate:ctrl_alt_bksp
```
